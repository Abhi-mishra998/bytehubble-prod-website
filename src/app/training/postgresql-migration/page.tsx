...
const STATS = [
  { value: "15", label: "Weeks", sub: "60-80 hours total" },
  { value: "14", label: "Modules", sub: "Comprehensive topics" },
  { value: "2", label: "Projects", sub: "Real-world migrations" },
  { value: "2", label: "Sources", sub: "Oracle & MSSQL" },
];

const OUTCOMES = [
  { icon: "🎯", tag: "Assessment", title: "Schema Assessment", desc: "Analyze database complexity using EDB Migration Portal and create comprehensive migration plans." },
  { icon: "🔄", tag: "Conversion", title: "Schema Conversion", desc: "Convert Oracle and MSSQL schemas to PostgreSQL with proper data type and constraint mapping." },
  { icon: "📊", tag: "Data Migration", title: "Data Migration", desc: "Execute full data migrations using EDB Toolkit with validation, checksums, and integrity verification." },
  { icon: "💻", tag: "Code Rewrite", title: "Code Conversion", desc: "Convert PL/SQL and T-SQL stored procedures to PL/pgSQL with proper syntax and semantics." },
  { icon: "⚡", tag: "Performance", title: "Performance Tuning", desc: "Optimize migrated databases using EXPLAIN ANALYZE, index tuning, and PostgreSQL configuration." },
  { icon: "☁️", tag: "Cloud Ready", title: "Cloud Migration", desc: "Deploy PostgreSQL to AWS RDS, Azure Database, and implement zero-downtime strategies." },
];

const CURRICULUM = [
  { phase: "0", weeks: "Week 1", title: "Foundations", desc: "Database migration drivers, Oracle vs PostgreSQL vs MSSQL architecture, key differences analysis." },
  { phase: "1", weeks: "Weeks 1-2", title: "Migration Strategy & Planning", desc: "Big Bang vs Phased vs Hybrid approaches, EDB lifecycle phases, business case analysis." },
  { phase: "2", weeks: "Weeks 2-3", title: "Assessment Phase", desc: "Schema assessment, code complexity evaluation, EDB Migration Portal walkthrough and analysis." },
  { phase: "3", weeks: "Weeks 3-5", title: "Schema Migration", desc: "Data type conversions, table and index mapping, views and triggers, Oracle package decomposition." },
  { phase: "4", weeks: "Weeks 5-6", title: "Data Migration", desc: "Offline/online/incremental approaches, EDB Toolkit deep dive, validation and checksum verification." },
  { phase: "5", weeks: "Weeks 6-8", title: "Code Conversion", desc: "PL/SQL to PL/pgSQL, T-SQL to PL/pgSQL, exception handling, loops, unsupported features workarounds." },
  { phase: "6", weeks: "Weeks 8-9", title: "Testing & Validation", desc: "Functional testing, performance testing, baseline metrics, comparative analysis and reporting." },
  { phase: "7", weeks: "Weeks 9-10", title: "Performance Tuning", desc: "EXPLAIN ANALYZE, index optimization, query rewriting, work_mem, shared_buffers, autovacuum tuning." },
  { phase: "8", weeks: "Week 10-11", title: "Cutover & Deployment", desc: "Cutover planning, downtime estimation, connection string updates, rollback plans, go-live checklist." },
  { phase: "9", weeks: "Week 11", title: "Tools Deep Dive", desc: "EDB tools, Ora2Pg, pgloader, AWS SCT, AWS DMS, Azure DMS, pgAdmin, pgBench, DBeaver." },
  { phase: "10", weeks: "Week 12", title: "MSSQL Specific", desc: "Identity vs SEQUENCE, T-SQL differences, collation handling, end-to-end SQL Server migration flow." },
  { phase: "11", weeks: "Weeks 12-14", title: "Real-Time Projects", desc: "Oracle HR Schema migration, MSSQL database migration with validation, optimization, and reports." },
  { phase: "12", weeks: "Week 14", title: "Advanced Topics", desc: "Zero-downtime logical replication, CDC, hybrid partial migrations, cloud migrations, best practices." },
  { phase: "13", weeks: "Week 15", title: "Troubleshooting & Career", desc: "Common issues resolution, debug strategies, interview prep, migration Q&A, job readiness." },
];

const MODULES = [
  { num: "01", badge: "Foundations", title: "Migration Drivers & Architecture", desc: "Business case for migrations, cost reduction benefits, database architecture comparison." },
  { num: "02", badge: "Planning", title: "Migration Strategy & Lifecycle", desc: "Big Bang, Phased, and Hybrid approaches with EDB six-phase migration lifecycle." },
  { num: "03", badge: "Assessment", title: "Assessment Phase", desc: "Schema and code complexity assessment using EDB Migration Portal for analysis." },
  { num: "04", badge: "Schema", title: "Schema Migration", desc: "Data type mapping, constraint conversion, views, triggers, package decomposition." },
  { num: "05", badge: "Data", title: "Data Migration", desc: "Offline/online/incremental approaches, EDB Toolkit, validation, and checksum verification." },
  { num: "06", badge: "Code", title: "Code Conversion", desc: "PL/SQL and T-SQL to PL/pgSQL with exception handling, loops, and workarounds." },
  { num: "07", badge: "Testing", title: "Testing & Validation", desc: "Functional and performance testing with baseline metrics and comparative analysis." },
  { num: "08", badge: "Tuning", title: "Performance Tuning", desc: "EXPLAIN ANALYZE, index tuning, query optimization, and PostgreSQL configuration." },
  { num: "09", badge: "Cutover", title: "Cutover & Deployment", desc: "Cutover planning, risk mitigation, rollback strategies, and go-live execution." },
  { num: "10", badge: "Tools", title: "Migration Tools Mastery", desc: "EDB Portal/Toolkit, Ora2Pg, pgloader, AWS DMS, Azure DMS, and open-source tools." },
  { num: "11", badge: "MSSQL", title: "MSSQL to PostgreSQL", desc: "Identity vs SEQUENCE, T-SQL specific features, collation handling, end-to-end flow." },
  { num: "12", badge: "Projects", title: "Capstone Projects", desc: "Oracle HR migration and MSSQL database migration with full validation and optimization." },
  { num: "13", badge: "Advanced", title: "Advanced & Cloud", desc: "Zero-downtime replication, hybrid migrations, AWS RDS, Azure Database deployments." },
  { num: "14", badge: "Career", title: "Troubleshooting & Job Prep", desc: "Common issues debugging, troubleshooting strategies, interview prep, and career resources." },
];
    ...
    <form onSubmit={submit} className="space-y-3 sm:space-y-4">
      ...
      <div className="flex items-start gap-3 p-4 rounded-lg bg-gray-50 border border-gray-200">
        ...
        <label htmlFor="agreed" className="text-sm text-dark-accent/60 leading-relaxed cursor-pointer">
          I agree to the program terms and commit to the 15-week schedule. Seats are limited and subject to selection.
        </label>
      </div>
...
export default function PostgreSQLMigrationPage() {
  return (
    <>
      <div className="pt-20">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex justify-center mb-5">
                <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/8 border border-primary/20 text-primary text-xs font-semibold">
                  ...
                  Enterprise Migration Expertise · 2025
                </span>
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-dark-accent leading-tight tracking-tight mb-5">
                PostgreSQL<br />
                <span className="text-primary">Migration</span> <span className="text-primary">Mastery</span>
              </h1>
              <p className="text-base sm:text-lg text-dark-accent/60 leading-relaxed max-w-2xl mx-auto mb-8">
                Master enterprise-grade database migrations from Oracle and MSSQL to PostgreSQL — schema conversion, data migration, code rewriting, and zero-downtime deployment.
              </p>
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-white">
          <Container>
            <SectionLabel label="Learning Outcomes" title="What You'll Master" desc="Comprehensive skills for enterprise database migrations" />
        ...
        <section id="curriculum" className="py-16 sm:py-20 lg:py-24 bg-background">
          <Container>
            <SectionLabel label="Program Structure" title="15-Week Curriculum" desc="Master complete database migration lifecycle from Oracle and MSSQL to PostgreSQL" />
        ...
        <section className="py-16 sm:py-20 lg:py-24 bg-white">
          <Container>
            <SectionLabel label="Core Modules" title="Comprehensive Topics" desc="14 detailed modules covering all aspects of enterprise database migrations" />
        ...
        <section id="apply" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-white to-background">
          <Container>
            <div className="max-w-2xl mx-auto">
              <SectionLabel label="Apply Now" title="Join PostgreSQL Migration Program" desc="Fill out the application form below. Limited seats available." />
